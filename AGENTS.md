...
- The former static prototype directory `statische-site/` has been retired. All future work must happen in the Rails app architecture (`app/views`, `app/controllers`, `app/javascript`, `app/assets`, routes, tests, and related Rails-owned files), not in a parallel static-site structure.
