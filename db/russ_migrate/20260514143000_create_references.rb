class CreateReferences < ActiveRecord::Migration[8.1]
  REFERENCES = [
    ...
    [ "STUTTGARTLIVE FESTIVAL", "2026-09-05", "Kultur- und Kongresszentrum", "SKS Michael Russ", "Ein Abend mit dichtem Timetable, klarer Kommunikation und verlässlicher Produktion.", "russ_live/references/22-stuttgart-live-festival.png", "1x1" ],
    ...
    [ "STUTTGARTLIVE FESTIVAL", "2023-11-28", "Theaterhaus Stuttgart", "Live Nation", "Lokale Umsetzung mit präziser Abstimmung zwischen Produktion, Venue und Vermarktung.", "russ_live/references/32-stuttgart-live-festival.png", "2x1" ],
    ...
    [ "STUTTGARTLIVE Festival", "2020-06-29", "Hanns-Martin-Schleyer-Halle", "Semmel Concerts", "Regionale Aktivierung, Medienarbeit und Vor-Ort-Abwicklung im eingespielten Team.", "russ_live/references/35-stuttgart-live-festival.png", "1x1" ],
