class RebackfillReferenceStartsOnFromDisplayDate < ActiveRecord::Migration[8.1]
  def up
  ...
  def down
    # Existing sort dates cannot be restored reliably because display_date is free text.
  end
end
